...
class Emergency(models.Model):
    ...
    location = models.CharField(('Place of Residence'),max_length= 125,null=True,blank=False)
...
class Relationship(models.Model):
    ...
    employee = models.ForeignKey('Employee',on_delete=models.CASCADE,null=True,blank=True)
    status = models.CharField(('Marital Status'),max_length=10,default=SINGLE,choices=STATUS,blank=False,null=True)
    spouse = models.CharField(('Spouse (Fullname)'),max_length=255,blank=True,null=True)
    occupation = models.CharField(('Occupation'),max_length=125,help_text='spouse occupation',blank=True,null=True)
    ...
    children = models.PositiveIntegerField(('Number of Children'),null=True,blank=True,default=0)

    #recently added - 29/03/19
    nextofkin = models.CharField(('Next of Kin'),max_length=255,blank=False,null=True,help_text='fullname of next of kin')
    ...
    relationship = models.CharField(('Relationship with Next of Person'),help_text='Who is this person to you ?',max_length=15,choices=NEXTOFKIN_RELATIONSHIP,blank=False,null=True)
    
    # close recent

    father = models.CharField(('Father\'s Name'),max_length=255,blank=True,null=True)
    foccupation = models.CharField(('Father\'s Occupation'),max_length=125,help_text='',blank=True,null=True)

    mother = models.CharField(('Mother\'s Name'),max_length=255,blank=True,null=True)
    moccupation = models.CharField(('Mother\'s Occupation'),max_length=125,help_text='',blank=True,null=True)
...
class Employee(models.Model):
    ...
    title = models.CharField(('Title'),max_length=80,default=MR,choices=TITLE,blank=False,null=True)
    ...
    sex = models.CharField(('Gender'),max_length=100,default=MALE,choices=GENDER,blank=False)
    email = models.CharField(('Email (optional)'),max_length=255,default=None,blank=True,null=True)
    # tel = PhoneNumberField(default='+233240000000', null = False, blank=False, verbose_name='Phone Number (Example +233240000000)', help_text= 'Enter number with Country Code Eg. +233240000000')
    bio = models.CharField(('Bio'),help_text='your biography,tell me something about yourself eg. i love working ...',max_length=255,default='',null=True,blank=True)
    birthday = models.DateField(('Birthday'),blank=False,null=False)
    religion = models.ForeignKey(Religion,verbose_name =('Religion'),on_delete=models.SET_NULL,null=True,default=None)
    nationality = models.ForeignKey(Nationality,verbose_name =('Nationality'),on_delete=models.SET_NULL,null=True,default=None)
    hometown = models.CharField(('Hometown'),max_length=125,null=True,blank=True)
    region = models.CharField(('Region'),help_text='what region of the country(Ghana) are you from ?',max_length=20,default=GREATER,choices=GHANA_REGIONS,blank=False,null=True)
    residence = models.CharField(('Current Residence'),max_length=125,null=False,blank=False)
    address = models.CharField(('Address'),help_text='address of current residence',max_length=125,null=True,blank=True)
    
    education = models.CharField(('Education'),help_text='highest educational standard ie. your last level of schooling',max_length=20,default=SENIORHIGH,choices=EDUCATIONAL_LEVEL,blank=False,null=True)
    ...
    ssnitnumber = models.CharField(('SSNIT Number'),max_length=30,null=True,blank=True)
    tinnumber = models.CharField(('TIN'),max_length=15,null=True,blank=True)
    ...
    startdate = models.DateField(('Employement Date'),help_text='date of employement',blank=False,null=True)
    employeetype = models.CharField(('Employee Type'),max_length=15,default=FULL_TIME,choices=EMPLOYEETYPE,blank=False,null=True)
    employeeid = models.CharField(('Employee ID Number'),max_length=10,null=True,blank=True)
    dateissued = models.DateField(('Date Issued'),help_text='date staff id was issued',blank=False,null=True)
    #app related
    is_blocked = models.BooleanField(('Is Blocked'),help_text='button to toggle employee block and unblock',default=False)
    is_deleted = models.BooleanField(('Is Deleted'),help_text='button to toggle employee deleted and undelete',default=False)
