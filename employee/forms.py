...
class EmergencyCreateForm(forms.ModelForm):
	...
	class Meta:
		model = Emergency
		fields = ['employee','fullname','location','relationship']
...
class FamilyCreateForm(forms.ModelForm):
	...
	class Meta:
		model = Relationship
		fields = ['employee','status','spouse','occupation','children','nextofkin','relationship','father','foccupation','mother','moccupation']
